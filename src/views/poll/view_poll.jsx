...
import { isAuthenticated, setLocalStorage } from '../../helpers/localstorage';
import { Link, useParams } from 'react-router-dom';
import { checkPasswordProtection, getPollByPollId, submitPoll } from '../../services/poll.service';
import { formattedDateFromNow, shuffleArray } from '../../helpers/common';
import { errorToast, successToast } from '../../utils/toaster';
import { submitPollValidation } from '../../validations/poll';
...
export default function ViewPoll() {
    ...
    const loadData = async () => {
        try {
            let response = await checkPasswordProtection(pollId)
    ...
    const loadPoll = async (e) => {
        try {
            e.preventDefault();
            setLoading(true);
            const res = await getPollByPollId(pollId, password);
            setPoll(res.data);
