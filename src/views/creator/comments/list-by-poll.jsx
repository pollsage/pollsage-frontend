...
import { getCommentsByPollId } from '../../../services/creator/comment.service';
...
export default function CommentsByPoll() {
    ...
    const loadData = async () => {
        try {
            let res = await getCommentsByPollId(pollId);
            setComments(res.data.docs);
            setPoll(res.data.poll);
            delete res.data.poll;
